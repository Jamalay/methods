const users = [
  ...
  getUserById(users,3); // должен вывести в консоль объект юзера с id === 2
  ...
  function removeAddresses(array) {
    return newArr = array.map(person => delete person.address)
  }
  ...
  function deleteUser(array, id) {
    return newArr = array.filter(person => person.id !== id);
  }
...
getUsersCompany(users, 10);
  ...
  console.log(changePhone(users, 9, '10009999990'));
